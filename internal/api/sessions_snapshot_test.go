	...
	want := []activeSessionDTO{
		{
			...
			Branch: "bA", WorktreePath: "/wtA", Mode: "worktree", PermissionMode: "ask", LastActiveAt: 300, AgentStatus: "busy",
		...
		},
		{
			...
			Branch: "bB", WorktreePath: "/wtB", Mode: "worktree", PermissionMode: "ask", LastActiveAt: 200,
