...
// 全部端点契约以 OpenCode 1.18.9 源码核验为基线（contract fixture 固化，见 §20），
// 漂移只改本包一处。
//
...
// ParentID 非空表示 background subagent 子会话（1.18.9 契约：Session 有 parentID 字段，
...
// ParentID 从 Event 提取 properties.info.parentID（1.18.9 契约：Session 有 parentID 字段，
