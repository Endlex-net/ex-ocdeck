# active-sessions-stream 变更 Delta

（本 capability 由 sse-active-sessions 引入（该变更已完成待归档）；本 delta 基于其 ADDED 内容做路径与消费者范围修订。sse-active-sessions 自身的 design/spec 文档不改写，归档时本 delta 逐 requirement 覆盖。）
